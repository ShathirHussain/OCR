...
//    }
    ...
    private void takePhoto() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            File photoFile = null;
            Log.println(Log.ASSERT,"CAMERA PREFERENCE", String.valueOf(MEDIA_preference));
            try {
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case OPEN_GALLERY_REQUEST_CODE:
                    ...
                    Bitmap bitmap = null;
                    try {
                        Log.println(Log.ASSERT,"MEDIA","MEDIA Values are taken");
                        bitmap = MediaStore.Images.Media.getBitmap(getContentResolver(), uri);
                        getContentResolver().delete(uri, null, null);
                        cur_predict_image = bitmap;
                        ivInputImage.setImageBitmap(bitmap);
                    } catch (IOException e) {
                        Log.println(Log.ASSERT,"MEDIA",";MEDIA Values are not taken");
                        e.printStackTrace();
                    }
//                    try {
...
//                    }
    ...
    public void btn_choice_img_click(View view) {
        if (requestAllPermissions()) {
//            openGallery();
            MEDIA_preference = ScanConstants.OPEN_MEDIA;
            Log.println(Log.ASSERT,"MEDIA PREFERENCE", String.valueOf(MEDIA_preference));
            Intent intent = new Intent(this, ScanActivity.class);
            intent.putExtra(ScanConstants.OPEN_INTENT_PREFERENCE, MEDIA_preference);
            Log.println(Log.ASSERT,"BROWSE","GETTING INTO BROWSE");
            Log.println(Log.ASSERT,"BROWSE", String.valueOf(intent));
            startActivityForResult(intent, OPEN_GALLERY_REQUEST_CODE);
